package com.khang.knowpost.listener;

import com.khang.counter.event.CounterEvent;
import com.khang.knowpost.service.FeedCacheService;
import com.github.benmanes.caffeine.cache.Cache;
import com.khang.knowpost.api.dto.FeedPageResponse;
...
public class FeedCacheInvalidationListener {
    ...
    private final com.khang.counter.service.UserCounterService userCounterService;
    private final com.khang.knowpost.mapper.KnowPostMapper knowPostMapper;
    ...
    public FeedCacheInvalidationListener(FeedCacheService feedCacheService,
                                         ...
                                         com.khang.counter.service.UserCounterService userCounterService,
                                         com.khang.knowpost.mapper.KnowPostMapper knowPostMapper) {
    ...
    public void onCounterChanged(CounterEvent event) {
        ...
        if ("like".equals(metric) || "fav".equals(metric)) {
            ...
            try {
                com.khang.knowpost.model.KnowPost post = knowPostMapper.findById(Long.valueOf(eid));
    ...
    private FeedPageResponse adjustPageCounts(FeedPageResponse page, String eid, String metric, int delta, boolean preserveUserFlags) {
        java.util.List<com.khang.knowpost.api.dto.FeedItemResponse> items = new java.util.ArrayList<>(page.items().size());
        for (com.khang.knowpost.api.dto.FeedItemResponse it : page.items()) {
                if (eid.equals(it.id())) {
                    ...
                    it = new com.khang.knowpost.api.dto.FeedItemResponse(it.id(), it.title(), it.description(), it.coverImage(), it.tags(), it.authorAvatar(), it.authorNickname(), it.tagJson(), like, fav, liked, faved, it.isTop());
                }
                items.add(it);
            }
